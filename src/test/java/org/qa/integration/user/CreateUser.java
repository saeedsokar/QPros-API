...
public class CreateUser extends RestBaseTest {
    @org.testng.annotations.DataProvider
    private static String[][] getPostUser() {
        return RestBaseTest.getCustomDataProvider("./src/main/resources/createUser-test-data.xlsx", "createUser", true);
    }

    @Test(priority = 0, dataProvider = "getPostUser", retryAnalyzer = FlakyRetry.class)
    public void createUser( String payload , String statusCode) {
        try {
            ...
            String completeEndpoint = buildFullPath() ;
            ...
            ValidatableResponse response = RequestHandler.postRequest(requestModel).
                    assertThat().
